...
<p>Please fill out this form to register wiht us</p>
...
<div class="form-group">
<div class="col-sm-6">
<select  name="role" class="form-control form-control-lg <?php echo (!empty($data['role_err'])) ?
'is-invalid' : ''; ?>" value="<?php echo $data['role'];?>">>
